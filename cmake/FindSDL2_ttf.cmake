...
#
# Created by Kesco Lin. This was influenced by the FindSDL.cmake
# module and the FindSDL_image.cmake, but with modifications to recognize OS X frameworks and
...
if(NOT SDL2_TTF_LIBRARIES AND SDL2TTF_LIBRARY)
	set(SDL2_TTF_LIBRARIES ${SDL2TTF_LIBRARY} CACHE FILEPATH "file cache entry initialized from old variable name")
endif()
...
if(SDL2_TTF_INCLUDE_DIR AND EXISTS "${SDL2_TTF_INCLUDE_DIR}/SDL_ttf.h")
	...
	file(STRINGS "${SDL2_TTF_INCLUDE_DIR}/SDL_ttf.h" SDL2_TTF_VERSION_MAJOR_LINE REGEX "^#define[ \t]+SDL2_TTF_MINOR_VERSION[ \t]+[0-9]+$")
	...
	string(REGEX REPLACE "^#define[ \t]+SDL2_TTF_MINOR_VERSION[ \t]+([0-9]+)$" "\\1" SDL2_TTF_VERSION_MINOR "${SDL2_TTF_VERSION_MAJOR_LINE}")
