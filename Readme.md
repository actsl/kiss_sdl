This is an example of using kiss_sdl GUI widget toolkit with Android for building an Android app in Linux. It is a part of the project https://github.com/actsl/kiss_sdl .
